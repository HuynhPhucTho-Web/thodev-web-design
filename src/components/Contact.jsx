  ...
  const contacts = [
    {
      ...
      desc: 'Xem các mã nguồn dự án, thư viện hoạt ảnh và sản phẩm lập trình mã nguồn mở của tôi.',
      icon: (
    ...
    },
    {
      ...
      link: 'https://www.linkedin.com/in/huynh-phuc-065843210/', // Customizable
      desc: 'Kết nối mạng lưới chuyên nghiệp, cập nhật các hoạt động thiết kế và cơ hội hợp tác phát triển.',
      icon: (
        <svg className="w-6 h-6 fill-current text-[#CCFF00]" viewBox="0 0 24 24">
    ...
    },
    {
      name: 'ZALO CHAT',
      value: '0702873790',
      link: 'https://zalo.me/0702873790', // Customizable
      desc: 'Kênh liên hệ nhanh chóng trực tiếp qua tin nhắn Zalo phục vụ trao đổi yêu cầu thiết kế 24/7.',
      icon: (
        // Custom clean speech bubble styled Zalo icon
    ...
    },
    {
      ...
      link: 'mailto:contact@thodev.vn',
      desc: 'Gửi yêu cầu dự án chi tiết, tài liệu brief thiết kế hoặc thư mời cộng tác thương mại.',
      icon: (
        ...
        <div className="lg:col-span-4 flex flex-col justify-between">
          <div>
            ...
            <p className="text-[#c6c6cc] text-sm md:text-base mt-4 leading-relaxed pr-4">
              Bạn đã sẵn sàng để nâng cấp diện mạo số cho thương hiệu? Hãy liên hệ trực tiếp với chúng tôi qua các kênh mạng xã hội, chat nhanh hoặc email chính thức để thảo luận sâu hơn.
            </p>
          </div>
          
          <div className="mt-8 pt-6 border-t border-[#22262E] font-mono-technical text-[10px] text-[#45474b]">
            <p>RESPONSE_TIME: &lt; 2 HOURS</p>
            <p className="mt-1">SECURE_PROTOCOL: SSL_VERIFIED</p>
          </div>
        </div>
